...
@TableName("stock_direct_return_detail")
public class DirectReturnDetail extends DataEntity<DirectReturnDetail> implements Serializable {
     ...
     * 退货id
     */
    @TableField("direct_return_id")
    private String directReturnId;
	...
	public String getDirectReturnId() {
		return directReturnId;
	}

	public void setDirectReturnId(String directReturnId) {
