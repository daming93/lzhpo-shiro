...
@TableName("stock_direct_return")
public class DirectReturn extends DataEntity<DirectReturn> implements Serializable {
    ...
    @TableField(exist = false)
    private List<DirectReturnDetail> detailSet;
	...
	public List<DirectReturnDetail> getDetailSet() {
		return detailSet;
	}

	public void setDetailSet(List<DirectReturnDetail> detailSet) {
