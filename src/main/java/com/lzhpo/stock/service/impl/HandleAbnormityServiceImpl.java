 ...
 */
@Service
public class HandleAbnormityServiceImpl extends ServiceImpl<HandleAbnormityMapper, HandleAbnormity>
		implements IHandleAbnormityService {
	@Override
	...
	@Override
	public HandleAbnormity getHandleAbnormityByTakeoutId(String tableId) {
		QueryWrapper<HandleAbnormity> wrapper = new QueryWrapper<>();
		// 下行编辑条件
		wrapper.eq("del_flag", false);
		wrapper.eq("takeout_id", tableId);
	...
	@Override
	public long getHandleAbnormityCountBywaybillId(String waybillId) {
		QueryWrapper<HandleAbnormity> wrapper = new QueryWrapper<>();
		// 下行编辑条件
		wrapper.eq("del_flag", false);
