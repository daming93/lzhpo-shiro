 ...
 */
@Controller
@RequestMapping("customer/abnormity")
public class AbnormityController {
	...
	public String list() {
		return "customer/abnormity/listAbnormity";
	}

	/**
	 * 查询分页数据
	 */
	@RequiresPermissions("customer:abnormity:list")
	@PostMapping("list")
	@ResponseBody
	...
	private List<Abnormity> setUserToAbnormity(List<Abnormity> abnormitys) {
		abnormitys.forEach(r -> {
			...
			if(StringUtils.isNotBlank(r.getAbnormityTypeId())){
				r.setAbnormityTypeStr(abnormityTypeService.getById(r.getAbnormityTypeId()).getName());
			}
		});
	...
	public String add(ModelMap modelMap) {
		modelMap.addAttribute("abnormityList", abnormityTypeService.selectAll());
		return "customer/abnormity/addAbnormity";
	}

	@RequiresPermissions("customer:abnormity:add")
	@PostMapping("add")
	@ResponseBody
	@SysLog("保存新增数据")
	...
	@RequiresPermissions("customer:abnormity:delete")
	@PostMapping("delete")
	@ResponseBody
	@SysLog("删除数据")
	...
	public String edit(String id, ModelMap modelMap) {
		...
		return "customer/abnormity/editAbnormity";
	}

	@RequiresPermissions("customer:abnormity:edit")
	@PostMapping("edit")
	@ResponseBody
	@SysLog("保存编辑数据")
	...
	@ResponseBody
	@SysLog("联动选择异常原因")
	public List<Abnormity> selectAbnorityByType(@RequestParam(value = "type", required = true)String type){
