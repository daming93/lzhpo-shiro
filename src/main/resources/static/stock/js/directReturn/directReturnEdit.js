...
window.viewObj = {
    ...
    layui.use(['jquery', 'table','upload', 'layer'], function(){
        ...
        var directReturnId =     document.getElementById("directReturnId").value;   

        var tableData=new Array(); // 用于存放表格数据
        $.ajax({
          url: "/stock/directReturn/selectDetail?returnId="+directReturnId+"&limit=2000"
          ,type:"get"
          ,async:false
          ,dataType:"json"
...
//提交数据代码
        form.on('submit(editdirectReturn)',function(data){
