...
window.viewObj = {
    ...
    layui.use(['jquery', 'table','upload', 'layer'], function(){
      ...
      //回车操作
        ...
        var vehicleContractMainId =     document.getElementById("vehicleContractMainId").value;   
        var tableData=new Array(); // 用于存放表格数据
        $.ajax({
          url: "/deliver/vehicleContractMain/selectDetail?contractId="+vehicleContractMainId
          ,type:"get"
          ,async:false
          ,dataType:"json"
        ...
        var tableIns = table.render({
            ...
            cols: [[
                 ...
                 { field:'money',title:'金额',edit: 'select',align:'center',width:100},
...
//提交数据代码
        form.on('submit(editvehicleContractMain)',function(data){
        ...
        $.ajax({
            type:"POST",
            url:"/deliver/vehicleContractMain/edit",
            dataType:"json",
